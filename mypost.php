...
<CENTER><h1>PROPERTIES</h1></CENTER>
    ...
    <!-- about--> <?php
                        ...
                        $sql="SELECT * FROM property where username='$user'";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn bg-theme mt-4 wthree-link-bnr" href="">FOR SALE
                        </a>
...
<br><br>
                ...
                <div class="col-lg-6">
                    <div class="single_grid_text">
                     ...
                     <tr> <td>   <a class="btn bg-theme1 mt-4 wthree-link-bnr" href="#"><?php echo $rows[5]?>
                        </a></td></tr><br>
