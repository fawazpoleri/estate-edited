...
<br><br><br><br><br>
                        ...
                        <table class="table table-hover" border="2" align="center">
                            ...
                            $sq=mysqli_query($con,"SELECT intrest,username FROM Feedback ");
                            if(mysqli_num_rows($sq))
                            {
                                ...
                                <tr>
                                   ...
                                   <td><input type="submit" name="reply"  class="form-control btn btn-success" value="REPLY"></td> 
                                   <td><input type="submit" name="delete"  class="form-control btn btn-danger" value="DELETE"></td></form>
                              
                                    <td> <a href="feedreply.php?id=<?php echo $res['username'];?>"><button type="button" class="btn btn-primary" >Reply</button></a></td></form>
