...
<div id="back" align="right">
    <a href="customerhome.php"><H3><font color="black">Back</font></H3></a>
</div>
<br><br>
...
<form method="post" id="view" >
        ...
        require("connect.php");
          $id=$_GET['id'];
        $result=mysqli_query($con,"select *  from property where  status='1' and username='$id'");
        ...
        if(mysqli_num_rows($result) >0)
        {
            ...
            while($row1=mysqli_fetch_array($result)){
                ?>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn bg-theme mt-4 wthree-link-bnr" href=""> <?php  echo  $row1[11]?>
                        </a>
